...
function addCheck(nStr)
    ...
    if(N>0){
        if (nStr<0 ) {
            document.querySelector("a").innerHTML= document.frmMain.txtNumberA.value+"  : 🚩Last guesses was too low!  ";
            N--;
          }
          else if (nStr > 0) {
            document.querySelector("b").innerHTML = document.frmMain.txtNumberA.value+"  : Last guesses was too high 🚩  ";
            N--;
          }
          else {
